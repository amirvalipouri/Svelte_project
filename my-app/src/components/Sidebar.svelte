...
<div class="relative " style="overflow-x: clip">
    <div
        id="sidebar"
        class=" sidebar fixed px-2 py-4 transition bg-gray-100 h-full overflow-x-hidden overflow-y-scroll z-50 mx-auto"
        style="width:15rem; background-color:white;"
        
    >
        <div class="relative mx-auto">
            <div class="absolute mx-auto " style="bottom: 0;  top:0;width: 15rem; trainsition: all 0.2s; border-right: 1px solid grey;">
...
<style>
    ...
    .btn{
        margin:2px;
        padding:4px;
        /* border:1px solid  rgba(156, 163, 175, var(--tw-text-opacity));
        border-radius: 50%; */
    }
</style>
