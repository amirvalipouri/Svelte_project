...
<div class="main w-full h-screen relative flex justify-center h-full  lg:flex lg:flex-wrap lg:justify-end">
    ...
    <div class="right bg-white  inline-block w-full  sm:w-full lg:w-1/3   px-2" >
        ...
        <div class="px-4 py-5 mt-4 space-y-6 w-full sm:p-6">
            ...
            <h3 class="">Sign In</h3>
            <p class="text-gray-300 text-md mt-2">Enter your email address and password to access admin panel.</p>
        </div>
        <form on:submit|preventDefault={login} action="#" method="POST" class="w-full min-w-full">
            <div class="sm:overflow-hidden w-full min-w-full">
              <div class="w-full min-w-full px-4 py-5 bg-white space-y-6 sm:p-6">
                <div class="">
                  <div class="col-span-3 sm:col-span-2 w-full min-w-full mt-2 mb-5">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm w-full min-w-full" >
                      <input  bind:value={userToLogin.username} type="email" name="company_website" id="company_website" class="p-3 flex-1 block min-w-full w-full rounded  sm:text-sm border border-gray-300" placeholder="Enter your email">
                    </div>
                  </div>
                  <div class="col-span-3 sm:col-span-2 mt-4 w-full  min-w-full" >
                    <div class="w-full flex justify-between min-w-full">
                        <label for="pass" class="w-full block text-sm font-medium text-gray-700">
                          ...
                          <span class="text-sm text-gray-300 cursor-pointer w-full" on:click={forgotPass}><a href="/authentication/forgotpassword">Forgot your password?</a></span>
                    </div>
                    <div class="mt-1 flex rounded-md shadow-sm w-full min-w-full">
                      <input bind:value={userToLogin.password} type="password" name="company_website" id="pass" class="p-3 flex-1 block w-full rounded rounded-r-0  sm:text-sm border border-gray-300" placeholder="Enter your password">
                      <span class=" inline-flex items-center px-3 cursor-pointer  border border-gray-300 bg-gray-50 text-gray-500 text-sm" >
                ...
                <button disabled={loginButtonDisabled} type="submit" class="w-full my-3 text-center text-white p-2" style="background-color: #3bafda;">Login</button>
                <p class="text-center text-gray-400 text-md">Don't have an account? <span on:click={register} class="text-md cursor-pointer hover:text-gray-700" style="color: #3bafda;"><a href="/authentication/signup">Sign Up</a></span></p>
              </div>
        ...
        <form action="#" method="POST" class="w-full min-w-full">
            <div class="sm:overflow-hidden w-full min-w-full">
              <div class="w-full min-w-full px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <p class="absulote bottom-0 text-center text-gray-400 text-md">Back to <span on:click={login} class="text-md cursor-pointer hover:text-gray-700" style="color: #3bafda;">Log In</span></p>
              </div>
        ...
        <form action="#" method="POST" class="w-full min-w-full" on:submit|preventDefault={login}>
            <div class="sm:overflow-hidden w-full min-w-full">
              <div class="w-full min-w-full px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <p class="text-center text-gray-400 text-md">Already have account? <span on:click={login} class="text-md cursor-pointer hover:text-gray-700" style="color: #3bafda;">Sign In</span></p>
              </div>
